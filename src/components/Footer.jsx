export default function Footer(img){
    return (
        <>
        <section className="bg-orange-700 px-8 py-8">
            <div className="max-w-5xl mx-auto flex items-center md:flex-row flex-col  justify-between">
                <h2 className="text-4xl text-center md:text-start text-white font-semibold w-full mb-6 md:w-2/5">Simplify how your team works today.</h2>
                <button className="px-6 py-3 rounded-full bg-white text-orange-700 hover:text-orange-500 hover:translate-x-2 hover:transition-all hover:duration-700 hover:delay-200 hover:scale-100">Get Started</button>
        ...
        <footer className="bg-gray-800 px-8 py-8">
            <div className="max-w-5xl mx-auto  flex flex-col-reverse md:flex-row items-center justify-between ">
                <div className="w-full md:w-1/4">
                    ...
                    <div className="flex justify-center md:justify-start mb-10 md:mb-0 gap-6">
                        ...
                        <span className="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"><path fill="#FFF" d="M10.333 0c-5.522 0-10 4.478-10 10 0 5.523 4.478 10 10 10 5.523 0 10-4.477 10-10 0-5.522-4.477-10-10-10zm3.701 14.077c-1.752.12-5.653.12-7.402 0C4.735 13.947 4.514 13.018 4.5 10c.014-3.024.237-3.947 2.132-4.077 1.749-.12 5.651-.12 7.402 0 1.898.13 2.118 1.059 2.133 4.077-.015 3.024-.238 3.947-2.133 4.077zM8.667 8.048l4.097 1.949-4.097 1.955V8.048z" className="hover:fill-red-500 hover:scale-105"/></svg>
                        </span>
                        <span className="">
                    ...
                    <div className="w-full flex gap-6 justify-between md:flex-row flex-col-reverse">
                    <div className="mb-6 w-full flex  justify-between   md:justify-around flex-row">
                    <div className="">
                        <ul className="space-y-2.5">
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="" className="">Home</a></li>
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="" className="">Pricing</a></li>
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="" className="">Products</a></li>
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="" className="">About Us</a></li>
                        </ul>
                    </div>
                    <div className="">
                    
                        <ul className="space-y-2.5">
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="">Careers</a></li>
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="">Community</a></li>
                            <li className="text-white font-semibold text-xl hover:text-orange-500  hover:translate-x-2  hover:transition-all hover:delay-300 hover:duration-1000"><a href="">Privacy Policy</a></li>
                        </ul>
                    ...
                    <div className="">
                        <div className="mb-10">
                            <form action="." className="flex justify-between md:gap-4">
                                <input type="email" placeholder="Updates in your inbox...."     className="px-6 py-3 border border-orange-700 focus:outline-none  rounded-full" id="" />
                                <button type="submit" className="px-6 py-3 rounded-full hover:bg-orange-400  hover:translate-x-1 md:hover:scale-125 hover:scale-90  hover:transition-all hover:delay-300 hover:duration-700 bg-orange-600 text-white font-medium">Go</button>
                            </form>
            ...
            <p className=" text-lg  md:text-end text-center mt-2 text-gray-500 font-semibold">Copyright 2020. All Rights Reserved</p>
        </footer>
        </>
    );
}